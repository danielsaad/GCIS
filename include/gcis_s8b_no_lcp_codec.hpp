...
#ifndef GC_IS_GCIS_S8_NO_LCP_CODEC_H
#define GC_IS_GCIS_S8_NO_LCP_CODEC_H
...
class gcis_s8b_no_lcp_codec_level {
  public:
    gcis_s8b_no_lcp_codec_level() = default;
    gcis_s8b_no_lcp_codec_level(gcis_s8b_no_lcp_codec_level &) = default;
    gcis_s8b_no_lcp_codec_level(gcis_s8b_no_lcp_codec_level &&) = default;
 ...
 */
class gcis_s8b_no_lcp_pointers_codec_level {
  public:
    // concatenaded rules
    sdsl::int_vector<> rule;
    // begin of each rule
...
class gcis_s8b_no_lcp_codec {
  ...
  public:
    ...
    gcis_s8b_no_lcp_pointers_codec_level decompress();
};

#endif // GC_IS_GCIS_S8_NO_LCP_CODEC_H
