...
def plot(csv_folder, plot_folder):
    ...
    plot_comparison(exp_name, gcis_total_rules,
                    repair_total_rules, plot_folder)
    plot_first_level_rules(exp_name, gcis_first_level_rules,
                           gcis_total_rules, plot_folder)
    plot_first_level_expansion(exp_name,gcis_first_level_expansion,plot_folder)
...
def plot_comparison(exp_name, a, b, plot_folder):
    fig = plt.figure()
    ax = fig.add_subplot(111)
    gap = .3
    width = .1
